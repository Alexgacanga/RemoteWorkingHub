<x-main-layout>
    <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-6 lg:p-8" style="font-family: 'Poppins', sans-serif;">
        ...
        <div class="w-full max-w-3xl bg-[#FFFFFF] rounded-2xl shadow-lg p-6 sm:p-8 md:p-10 relative">
            ...
            <!-- Header Section -->
            <div class="mb-8">
                <h2 class="text-2xl sm:text-3xl font-bold text-[#000000] mb-2 tracking-tight">Edit Package</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="name" name="name" required
                            ...
                            placeholder="e.g. Monthly Dedicated Desk Standard" value="{{ old('name', $package->name) }}">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3" required
                            ...
                            placeholder="Brief description of the package benefits...">{{ old('description', $package->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="price" name="price" step="0.01" min="0" required
                                ...
                                placeholder="Ksh. 0.00" value="{{ old('price', $package->price) }}">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="option_id" name="option_id" required
                                ...
                                <option value="{{ $option->id }}" {{ old('option_id', $package->option_id) == $option->id ? 'selected' : '' }}>
                                    {{ $option->name }}
                                </option>
                                @endforeach
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <select id="time_options" name="time_options" required
                                class="w-full px-4 py-3 bg-[#FFFFFF] border border-gray-300 rounded-xl text-[#000000] focus:outline-none focus:ring-2 focus:ring-[#4FC1FF] focus:border-transparent transition-all duration-300 appearance-none">
                                <option value="" disabled>Select Time Option</option>
                                <option value="day" {{ old('time_options', $package->time_options) == 'day' ? 'selected' : '' }}>Day</option>
                                <option value="week" {{ old('time_options', $package->time_options) == 'week' ? 'selected' : '' }}>Week</option>
                                <option value="month" {{ old('time_options', $package->time_options) == 'month' ? 'selected' : '' }}>Month</option>
                            </select>
                            <!-- Custom Dropdown Arrow -->
                            <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="md:col-span-2 flex items-center justify-between bg-gray-50 p-5 rounded-xl border border-gray-200 mt-2">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" id="statusToggle" name="is_active" value="1" class="sr-only peer" {{ old('is_active', $package->is_active ?? true) ? 'checked' : '' }}>
