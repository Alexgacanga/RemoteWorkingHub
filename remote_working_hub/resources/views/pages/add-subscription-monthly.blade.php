        ...
        <div class="w-full max-w-lg bg-[#FFFFFF] rounded-2xl shadow-lg p-6 sm:p-8 relative">
            ...
            <div class="mb-8">
                <h2 class="text-2xl sm:text-3xl font-bold text-[#000000] mb-2 tracking-tight leading-tight">
                    Create monthly subscription for <span class="text-[#FF6245]">{{ $customer->fname }}</span>
                </h2>
            ...
            @endif
            <!-- Form -->
            <form action="{{ route('monthly-subscriptions.store', $customer->id) }}" method="POST">
                @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="package_id" name="package_id" required
                                ...
                                <option value="{{ $package->id }}">{{ $package->name }} - Ksh. {{ number_format($package->price, 2) }}/month</option>
                                @endforeach
                            </select>
