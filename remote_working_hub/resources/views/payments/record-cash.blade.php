            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16 items-center">
                    <div class="flex items-center space-x-4">
                        ...
                        <h1 class="text-xl font-bold text-gray-900">Record Cash Payment</h1>
                    </div>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-100 bg-gray-50">
                    <h2 class="text-lg font-semibold text-gray-900">Cash Transaction Details</h2>
                    <p class="text-sm text-gray-500 mt-1">Register a physical cash payment received at the front desk.</p>
                </div>
                ...
                <form action="#" method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select id="customer_id" name="customer_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none shadow-sm bg-white">
                            ...
                            <option value="1">John Doe (+254712345678)</option>
                            <option value="2">Jane Smith (TechCorp Ltd)</option>
                        </select>
                    </div>

                    <!-- Package Select -->
                    <div>
                        <label for="package_id" class="block text-sm font-medium text-gray-700 mb-1">Rented Package</label>
                        <select id="package_id" name="package_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none shadow-sm bg-white">
                            ...
                            <option value="2">Weekly Board Room (KES 35,000)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="number" id="amount" name="amount" placeholder="0.00" required
                                class="w-full pl-12 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none shadow-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="3" placeholder="E.g., Exact amount handed, change given..."
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none shadow-sm resize-none"></textarea>
                    </div>
