...
<body class="bg-gray-100 text-gray-700 antialiased" style="font-family: 'Poppins', sans-serif;">
    <div class="flex h-screen overflow-hidden">
        ...
        <div id="mobileOverlay" class="fixed inset-0 z-30 hidden bg-black/40 md:hidden"></div>

        <div class="flex min-w-0 flex-1 flex-col overflow-hidden">
            <header
                class="flex h-20 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-4 shadow-sm md:px-8">
